...
<article class="page-container">
	<form action="/index.php/Admin/Manager/admin_edit/id/<?php echo ($mes["id"]); ?>.html" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
	<div class="row cl">
