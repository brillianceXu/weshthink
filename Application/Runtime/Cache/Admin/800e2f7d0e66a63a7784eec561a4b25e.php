    ...
    <div class="page-container">
        <form action="/index.php/Admin/Content/index<?php echo ($str); ?>.html" method="get">
            <div class="text-c">
                ...
                <button name="" id="" class="btn btn-primary" type="button" onclick="window.location.href='/index.php/Admin/Profession/article_add/pid/<?php echo ($pid); ?>.html';"><i class="Hui-iconfont">&#xe600;</i> 添加</button>
            </div>
        </form>
